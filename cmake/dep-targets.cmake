...
set(SDL2_SOURCE_URL     "https://github.com/libsdl-org/SDL/releases/download/release-2.24.0/SDL2-2.24.0.zip")
...
IF (WITH_VIDEO)
    IF (NOT PNG_FOUND)
        ...
        BuildDepMatrix(png-dep libpng
            CMAKE_ARGS -DPNG_SHARED:Bool=${BUILD_SHARED_DEPS}
    ...
    IF (NOT SDL2_ttf_FOUND)
        ...
        BuildDepMatrix(sdl2-ttf-dep SDL2_ttf CMAKE_ARGS "-DBUILD_SHARED_LIBS:Bool=${BUILD_SHARED_DEPS}")
