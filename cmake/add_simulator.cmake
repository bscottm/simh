...
function(build_simcore _targ)
    ...
    if (SIMH_VIDEO)
        ...
        if (CMAKE_HOST_APPLE AND NOT SIMH_BESM6_SDL_HACK)
            ...
            ##     the makefile filters out SDL_MAIN_AVAILABLE on MacOSX.
    ...
    target_compile_definitions("${_targ}" PUBLIC "SIM_BUILD_TOOL=${CMAKE_GENERATOR}")
...
function (simh_executable_template _targ)
    ...
    ## message(STATUS "${_targ} -> ${SIMH_SIMLIB}")
