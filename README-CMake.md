...
- Windows PowerShell:
    ...
    NAME
        [path]\open-simh\cmake\cmake-builder.ps1
    ...
    SYNTAX
        [path]\open-simh\cmake\cmake-builder.ps1 [[-flavor] <String>] [[-config] <String>] [[-target]    
    <String>] [-clean] [-help] [-nonetwork] [-novideo] [-notest] [-noinstall] [-parallel] [-generate] [-regenerate]  
    [-testonly] [-installOnly] [-windeprecation] [-package] [-lto] [-debug_wall] [<CommonParameters>]
